    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest req) {
        try {
            ...
            if ("EMPRESA".equals(tipo)) {
                ...
                // Professores devem ser pré-cadastrados, não podem se cadastrar publicamente
                return ResponseEntity.badRequest().body(new ErrorResponse("Professores devem ser pré-cadastrados pela instituição. Entre em contato com a administração."));
            } else {
